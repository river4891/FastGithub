...
dotnet publish -c Release /p:PublishSingleFile=true /p:PublishTrimmed=true --self-contained -r linux-musl-x64 -o "%output%/fastgithub_linux-musl-x64" ./FastGithub/FastGithub.csproj
